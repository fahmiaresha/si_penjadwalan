                        ...
                        @foreach($pricelist_sewa_armada as $pr)
                                    ...
                                    <!-- modal -->
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModal12Label">Edit Data Pricelist Sewa Armada</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <i class="ti-close"></i>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="jmlhari" class="col-form-label">Jumlah Hari :</label>
                                                    <input type="text" class="form-control" id="jmlhari" name="jmlhari" value="{{ $pr->JUMLAH_HARI }}">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
